...
import { Button, Kbd, Sheet, Slot, Splitter, Tooltip } from "@tau/ui";
...
export function Trigger() {
  ...
  useShortcut(sidebar.SHORTCUT, () => (mobileSidebar ? noop() : toggle("sidebar")));
...
export function GroupContent({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
