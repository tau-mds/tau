            ...
            <div className="flex flex-col items-center justify-center w-full text-center">
              <div className="space-y-2 w-full">
                ...
                <p className="max-w-2xl mx-auto text-xl md:text-2xl text-muted-foreground w-full">
                  Automatically match interviewers and candidates based on overlapping
                  availability. Sign in with Magic Link - no passwords required.
                </p>
              </div>
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="mx-auto max-w-[700px] text-muted-foreground md:text-xl">
                  Our platform offers powerful tools designed to streamline your workflow
            ...
            <div className="mx-auto grid w-full items-center gap-6 py-12 lg:grid-cols-3">
              <div className="flex flex-col items-center space-y-4 rounded-lg border border-surface-4 bg-surface-1 p-6 shadow-sm">
                ...
                <p className="text-center text-muted-foreground">
                  Automatically match interviewers and candidates based on overlapping
                  availability intervals for seamless scheduling.
                </p>
              </div>
              <div className="flex flex-col items-center space-y-4 rounded-lg border border-surface-4 bg-surface-1 p-6 shadow-sm">
                ...
                <p className="text-center text-muted-foreground">
                  Simple sign-in process with Magic Link for both interviewers and
                  candidates - no passwords to remember.
                </p>
              </div>
              <div className="flex flex-col items-center space-y-4 rounded-lg border border-surface-4 bg-surface-1 p-6 shadow-sm">
                <div className="rounded-full bg-primary/10 p-3">
                ...
                <p className="text-center text-muted-foreground">
                  Easy-to-use interface for expressing and managing availability across
          ...
          <div className="w-full px-8">
            ...
            <div className="mx-auto grid w-full gap-6 py-12 lg:grid-cols-2">
              <div className="flex flex-col justify-between rounded-lg border border-surface-4 bg-surface-1 p-6 shadow-sm">
                <div className="space-y-4">
                  <p className="text-muted-foreground">
                    Tau has revolutionized our hiring process. The automatic matching
                    saves us hours of back-and-forth scheduling emails every week.
                  </p>
                </div>
              ...
              <div className="flex flex-col justify-between rounded-lg border border-surface-4 bg-surface-1 p-6 shadow-sm">
                <div className="space-y-4">
                  <p className="text-muted-foreground">
                    Since using Tau, we've reduced our time-to-hire by 50%. The Magic Link
                    authentication makes it so easy for candidates to participate.
                  </p>
                </div>
                <div className="flex items-center gap-4 pt-4">
                  <UserRoundCheck className="h-10 w-10 text-primary rounded-full bg-muted p-2" />
              ...
              <div className="flex flex-col justify-between rounded-lg border border-surface-4 bg-surface-1 p-6 shadow-sm">
                <div className="space-y-4">
                  <p className="text-muted-foreground">
                    The automatic matching feature is incredible. No more scheduling
                    conflicts or missed interviews - everything just works seamlessly.
                  </p>
                </div>
                <div className="flex items-center gap-4 pt-4">
                  <UserRoundCheck className="h-10 w-10 text-primary rounded-full bg-muted p-2" />
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Recruiting Director, RemoteWorks
                    </p>
                  </div>
                </div>
              </div>
              <div className="flex flex-col justify-between rounded-lg border border-surface-4 bg-surface-1 p-6 shadow-sm">
                <div className="space-y-4">
                  <p className="text-muted-foreground">
                    Tau's smart scheduling has eliminated the administrative burden of
                    coordinating interviews. Our team can focus on what matters - finding
                    great talent.
                  </p>
                </div>
                <div className="flex items-center gap-4 pt-4">
          ...
          <div className="w-full px-8">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="mx-auto max-w-[700px] text-muted-foreground md:text-xl">
                  Join hundreds of companies that use Tau to automate interview scheduling
