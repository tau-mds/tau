...
export namespace ContextMenuSubTrigger {
	export type Props = React.ComponentProps<typeof ContextMenuPrimitive.SubTrigger> & {
		inset?: boolean;
	};
}
...
export namespace ContextMenuSubContent {
	export type Props = React.ComponentProps<typeof ContextMenuPrimitive.SubContent>;
}
...
export function ContextMenuContent({ className, ...props }: ContextMenuContent.Props) {
	return (
...
export namespace ContextMenuLabel {
	export type Props = React.ComponentProps<typeof ContextMenuPrimitive.Label> & {
		inset?: boolean;
	};
}
export function ContextMenuLabel({ className, inset, ...props }: ContextMenuLabel.Props) {
	return (
...
export function ContextMenuShortcut({ className, ...props }: ContextMenuShortcut.Props) {
	return (
		<span
