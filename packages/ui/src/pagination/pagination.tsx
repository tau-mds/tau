...
export function PaginationContent({ className, ...props }: PaginationContent.Props) {
  return (
    <ul
...
export function PaginationPrevious({ className, ...props }: PaginationPrevious.Props) {
  return (
    <PaginationLink
...
export function PaginationEllipsis({ className, ...props }: PaginationEllipsis.Props) {
  return (
    <span
      aria-hidden
