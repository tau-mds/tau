...
export function AlertDialogOverlay({ className, ...props }: AlertDialogOverlay.Props) {
  return (
...
export function AlertDialogContent({ className, ...props }: AlertDialogContent.Props) {
  return (
    <AlertDialogPortal>
      <AlertDialogOverlay />
...
export function AlertDialogHeader({ className, ...props }: AlertDialogHeader.Props) {
  return (
    <div
...
export function AlertDialogFooter({ className, ...props }: AlertDialogFooter.Props) {
  return (
    <div
...
export function AlertDialogTitle({ className, ...props }: AlertDialogTitle.Props) {
  return (
...
export namespace AlertDialogDescription {
  export type Props = React.ComponentProps<typeof AlertDialogPrimitive.Description>;
}
...
export function AlertDialogAction({ className, ...props }: AlertDialogAction.Props) {
  return (
...
export function AlertDialogCancel({ className, ...props }: AlertDialogCancel.Props) {
  return (
